 ...
 *   scripts/lib/inventory-schema.ts   — guild.inventory.v1 type + validator
 *   scripts/lib/parity-contract.ts    — DISCOVERY_RULES + checkCoverage (SC-7a)
 *   scripts/lib/result-contracts.ts   — RESULT_CONTRACTS (curated schemas[])
...
} from "./lib/parity-contract";
import { RESULT_CONTRACTS } from "./lib/result-contracts";

/** Default plugin root — scripts/ sits directly under the plugin repo root. */
