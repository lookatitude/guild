 ...
 *
 * Layer: shared/ — zero internal deps, only node builtins or external packages.
 ...
 *
 * Keep this file free of internal runtime imports: shared/ must remain usable by
 * both core settings code paths without pulling host/runtime layers upward.
 */
