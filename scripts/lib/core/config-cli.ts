...
interface ModelsBlock {
  ...
  /**
   * Composite recall scoring (docs/v2/knowledge-memory.html §Recall scoring). true (default) = wiki
  ...
  /**
   * Write-time importance-at-ingest scorer (docs/v2/knowledge-memory.html §Importance-at-ingest).
...
export const HELP: Record<string, string> = {
  ...
  "models.compositeRecall":
    "bool (default true) — composite recall scoring (docs/v2/knowledge-memory.html §Recall scoring). " +
  ...
  "models.importanceAtIngest":
    "bool (default true) — write-time importance-at-ingest scorer (docs/v2/knowledge-memory.html §Importance-at-ingest). " +
