  ...
  return {
    ...
    renderCommandSurface(request?: RenderCommandSurfaceRequest): HostAdapterResult {
      return result(
        ...
        {
          request: request ?? {},
          manifest_path: "antigravity-manifest.json",
    ...
    renderPackage(request?: RenderPackageRequest): HostAdapterResult {
      return result(
        "renderPackage",
        "degraded",
        "Antigravity package target renders antigravity-manifest.json plus Guild skill tree; installability remains target until live install evidence",
        {
          request: request ?? {},
          manifest_path: "antigravity-manifest.json",
          skill_root: ".agents/skills/guild",
