...
/**
 * understand/classify-wiki-pages.ts — L8: Real ClassifyPageFn implementation
 *
 ...
 *   import { makeClassifier } from "./understand/classify-wiki-pages";
 ...
 *   npx tsx scripts/understand/classify-wiki-pages.ts <wikiDir> [--print-prompt]
 *
