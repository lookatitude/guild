...
/**
 * understand/cost-gate.ts — SC-15 pre-flight cost gate for the knowledge tier.
 *
 * Usage: npx tsx understand/cost-gate.ts [--cwd <path>] [--json]
 *
