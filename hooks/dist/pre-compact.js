...
var fs6, path7, SECURITY_EVENT_SCHEMA_VERSION, KNOWN_GUILD_HOST_KINDS, KNOWN_GUILD_HOST_ID_SET, LEGACY_HOST_ALIASES2;
...
function readResolvedSettingsSnapshot(runId, opts) {
  ...
  const raw = fs10.readFile(filePath);
...
var crypto2, SIDECAR_MAX_BYTES2;
...
function appendEvent(runDir2, event, opts = {}) {
  ...
  if (opts.forceFallback || process.platform === "win32") {
    ...
    const path12 = laneFallbackPath(runDir2, laneId);
