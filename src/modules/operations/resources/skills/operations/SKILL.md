...
| Chapter | Covers |
|---|---|
| `references/ops-incident.md` | The incident runbook-class playbook for the guild:operations router — producer devops-incident-runbook, the guild.ops.v1 + guild.incident.v1 outputs, and the hard INTERACTIVE-always (never autonomous) posture |
| `references/ops-maintenance.md` | The maintenance runbook-class playbook for the guild:operations router — producer devops-infrastructure-as-code and the guild.ops.v1 output |
