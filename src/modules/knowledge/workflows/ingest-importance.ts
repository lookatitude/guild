 ...
 *
 * Write-time importance-at-ingest 1–5 scorer (docs/v2/knowledge-memory.md
...
import { splitFrontmatter } from "../../state";
 ...
 * context→2 design table (docs/v2/knowledge-memory.md §Importance-at-ingest), mapped onto Guild's
