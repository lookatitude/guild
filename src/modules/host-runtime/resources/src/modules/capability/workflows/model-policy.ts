...
export const POLICY_PURPOSES = Object.freeze([
  "general",
  "implementation",
  "planning",
  "research",
...
export const REVIEW_CLASS_PURPOSES = Object.freeze([
  "advisory",
  "adversarial",
  "security",
  "adversarial-security",
...
export const COMPLEXITIES = Object.freeze(["easy", "medium", "hard"] as const);
...
export const INDEPENDENCE_LEVELS = Object.freeze(["none", "prefer_cross_family", "require_cross_family"] as const);
export type IndependenceLevel = (typeof INDEPENDENCE_LEVELS)[number];

export const POLICY_TIERS = Object.freeze(["cheap", "mid", "powerful"] as const);
 ...
 */
export const OPERATOR_BASELINE_POLICY: ModelPolicyV2 = deepFreeze({
  version: 2,
