...
var require_dumper = __commonJS({
  "../scripts/node_modules/js-yaml/lib/js-yaml/dumper.js"(exports2, module2) {
    ...
    function safeDump(input, options) {
      return dump2(input, common.extend({ schema: DEFAULT_SAFE_SCHEMA }, options));
    }
...
function readSubscribers(runDir) {
  ...
  for (const name of entries) {
    ...
    try {
      const sub = validateBusSubscriberV1(yaml.load(fs8.readFileSync(path8.join(dir, name), "utf8")));
      if (sub) out.push(sub);
    } catch {
    }
  }
