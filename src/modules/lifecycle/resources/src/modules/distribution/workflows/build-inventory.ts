...
// Deliberately no require.main guard here. This workflow is a library module
// exported by the distribution public API and can be bundled transitively into
// hook entrypoints. Executable ownership belongs exclusively to the thin
// scripts/build-inventory.ts shim; duplicating the guard here makes esbuild
// treat this imported module as the bundle main and execute the wrong CLI.
