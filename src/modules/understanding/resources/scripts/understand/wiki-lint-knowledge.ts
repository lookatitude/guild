...
/**
 * understand/wiki-lint-knowledge.ts — L8: Knowledge graph lint check
 *
 ...
 *
 * Usage (standalone): npx tsx scripts/understand/wiki-lint-knowledge.ts <graph.json>
...
if (require.main === module) {
  ...
  if (!graphPath) {
    process.stderr.write(
      "Usage: npx tsx scripts/understand/wiki-lint-knowledge.ts <graph.json> [--json]\n",
    );
    process.exit(1);
  }
