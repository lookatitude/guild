...
7. **Register** — on both gates passing, move files live within `.guild/` (see DH-3 mint contract), commit the step-5 boundary edits, and make the skill routable for subsequent sessions.
