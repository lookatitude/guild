...
- **Launch plans, positioning, GTM** — launch announcements, positioning statements, messaging frameworks, campaign briefs, A/B copy variants. `marketing` owns (forthcoming in next P3 task).
- **Cold outreach and sales sequences** — cold email, multi-touch outreach, discovery scripts, proposals, follow-ups. `sales` owns (forthcoming in next P3 task).
