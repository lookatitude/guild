---
name: guild-evolve
description: "RENAMED in Guild v2 — print-only redirect stub. Prints the v1→v2 redirect and exits non-zero, runs nothing. Sunset: deleted at v2.1.0 (MIGRATION.md §5)."
---

# /guild:guild-evolve — renamed (print-only redirect stub)

This v1 command name was renamed in Guild v2. This file is a **print-only
...
```
/guild:guild-evolve was renamed in Guild v2.

  v2 equivalent:  /guild:evolve [skill] [--auto]
