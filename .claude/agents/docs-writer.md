...
- `guild-plan.md §6` — specialist roster (canonical: `https://lookatitude.github.io/guild-website/docs/specialist-roster`; also `docs/specialist-roster.md` kept in-repo for `scripts/check-roster-consistency.ts`).
...
- In-repo references to website pages use the placeholder `https://lookatitude.github.io/guild-website/docs/<slug>` (not a live hyperlink until the operator resolves the URL — see `docs/DOCS-SITE.md`).
