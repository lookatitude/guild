...
- In-repo references to website pages use the placeholder `https://guildstack.dev/docs/<slug>` (not a live hyperlink until the operator resolves the URL — see `docs/DOCS-SITE.md`).
