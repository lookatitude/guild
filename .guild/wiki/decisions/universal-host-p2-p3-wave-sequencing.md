...
owner: user
confidence: high
source_refs: [".guild/wiki/decisions/universal-host-plugin-architecture.md"]
...
## Options considered
- A: 3 waves — W1 steps 12–14 (additive product-loop/workspace/config-render), W2 steps 15–17
