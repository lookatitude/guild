...
importance: high
source_refs:
  - ".guild/wiki/_archive/v2-design/sources/06-human-agent-ux-orchestration-ui.md"
  - ".guild/wiki/_archive/v2-design/sources/research-backlog.md#L106"
...
([`06-human-agent-ux-orchestration-ui.md`](../../../../.guild/wiki/_archive/v2-design/sources/06-human-agent-ux-orchestration-ui.md))
...
- **[v2-contract-only]** — trace-based explainability: the
  ...
  as G-2, [v2-observability-and-replay](../../../../.guild/wiki/decisions/v2-observability-and-replay.md) §D-OBS-5).
...
2. **Stated principle.** The research backlog already closed the dashboard
   ...
   ([research-backlog.md#L106](../../../../.guild/wiki/_archive/v2-design/sources/research-backlog.md) — **CLOSED-in-v2 — NO**).
...
([v2-observability-and-replay](../../../../.guild/wiki/decisions/v2-observability-and-replay.md) §D-OBS-4). The
...
- *Why this specialist / context / plan order* — the `team`, `plan`, and
  ...
  [v2-observability-and-replay](../../../../.guild/wiki/decisions/v2-observability-and-replay.md) §D-OBS-5).
...
|---|---|---|
| Task DAG | `guild.run_state.v1` DAG/lane checkpoint on disk ([v2-observability-and-replay](../../../../.guild/wiki/decisions/v2-observability-and-replay.md) related) | task-DAG view |
